<div class="d-flex flex-column">
	...
	?>
			<div style="max-height:100px"><a class="text-decoration-none" href="index.php?action=detail&danhmuc=<?php echo $dm["tendm"]; ?>&id=<?php echo $x["id"]; ?>">
					<img style="width:100px; height: 100px;" class="img-thumbnail float-start m-2" src="../img/hoa/<?php echo $dm["tendm"]; ?>/<?php echo $x["hinhanh"]; ?>" alt="<?php echo $x["tenmh"]; ?>">
