        ...
        <footer class="py-5 bg-info">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-light">
                        ...
                        <h4><span class="badge text-white bg-success">A</span>
                            ...
                            <span class="badge text-white bg-warning">C</span> Shop - Cửa hàng hoa tươi Elko</h4></a>
                        <p><b><i>Địa chỉ:</i></b>18 Ung Văn Khiêm, phường Đông Xuyên, TP Long Xuyên, An Giang<br>
                            <b><i>Điện thoại:</i></b>076 3841190<br> 
                            <b><i>Email:</i></b> shop.elko@gmail.com</p>
                    </div>
                ...
                <hr>
                <p class="m-0 text-center text-warning fw-bolder">Copyright &copy; Elko Shop 2023</p></div>
        </footer>
