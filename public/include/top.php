                    ...
                    <div class="col-7 ">
                        <div class="d-flex">
                            <?php if (isset($_SESSION["nguoidung"])) { ?>
                                <a href="index.php?action=hoso&id=<?php echo $_SESSION["nguoidung"]["id"]; ?>" class="text-decoration-none text-dark btn">Xin chào bạn <?php echo $_SESSION["nguoidung"]["hoten"]; ?></a>&nbsp;
